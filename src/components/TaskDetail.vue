    ...
    <div class="flex items-center justify-center min-h-screen bg-black/[.05]">
      <div class="bg-white w-1/2 p-6 rounded shadow-lg grid grid-cols-3 gap-3">
        <div class="col-start-1 col-span-3">
          ...
          <div class="itbkk-title p-2 border-solid border-2 border-grey w-full mb-3" v-text="title"></div>
        </div>
        ...
        <div class="col-start-3 col-span-1">
          ...
          <select class="p-2 border-solid border-2 border-grey w-full mb-10 itbkk-status" v-model="status" disabled>
