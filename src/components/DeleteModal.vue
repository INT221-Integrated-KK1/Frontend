...
onMounted(async () => {
    try {
        ...
        taskTitle.value = task.value.taskTitle;
            ...
            <div class="flex items-center justify-center min-h-screen bg-black/[.05]">
                <div class="bg-white w-1/2 p-6 rounded shadow-lg">
                    <div class="">
                        ...
                        <hr>
                        <p class="text-lg py-2 mb-2 break-words">Do you want to delete the task "{{
                            taskTitle }}"?</p>

                        <div class="text-right ">
                            <router-link to="/task">
                                <button class="btn bg-green-500 hover:bg-green-700 text-white mr-3" @click="deleteTask">
                                    Confirm
                                </button>
                            </router-link>
                            <router-link to="/task">
