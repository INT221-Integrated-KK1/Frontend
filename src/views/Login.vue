      ...
      <div class="w-3/5 flex items-center justify-center animated-slide-in">
        <div class="w-1/2 max-w-md bg-white p-8 rounded-xl shadow-2xl space-y-6">
          ...
          <div
            ...
            <input type="text" class="w-full bg-transparent rounded-full px-6 py-4 focus:outline-none"
              v-model="inputForm.userName" placeholder="Username" :maxlength="50" />
          </div>
          ...
          <div
            ...
            <input :type="isPasswordToggle ? 'text' : 'password'"
              class="w-full bg-transparent rounded-full px-6 py-4 focus:outline-none" v-model="inputForm.password"
              placeholder="Password" :maxlength="14" />
